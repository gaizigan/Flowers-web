<%@ Page Title="Магазин 2" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" 
  CodeFile="store2.aspx.cs" Inherits="store2_store2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:TemplateField>
                 <ItemTemplate>
                    ...
                    OnCheckedChanged="checkedDelivery"
                     AutoPostBack="true"
                     Checked='<%#bool.Parse(Eval("isDelivered").ToString() == "True" ? "true" : "false") %>'
                    />
                 </ItemTemplate>
            </asp:TemplateField>
        ...
        <HeaderStyle BackColor="#2a9c3b" Font-Bold="True" ForeColor="White" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT OrderedItem.orders, Item.name, OrderedItem.counts,
         Orders.buyerPhone, Orders.destination, Orders.deliveringTimeTo,
          Orders.isDelivered, Orders.comments FROM OrderedItem INNER JOIN Orders
           ON OrderedItem.orders = Orders.id INNER JOIN Item ON OrderedItem.item = Item.id WHERE (Orders.store = @storeID)"   
